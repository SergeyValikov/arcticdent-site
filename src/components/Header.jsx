    ...
    <header className="header">
      ...
      <div className="header__actions">
        ...
        <div className="header__socials" aria-label="Социальные сети">
          ...
          <a className="header__social-link header__social-link--profile" href="#profile" aria-label="Профиль клиники">
            <svg viewBox="0 0 56 56" aria-hidden="true" focusable="false">
              <path d="M28 4.2c-13.1 0-22.6 9.25-22.6 21.75v23.6l7.55-5.35A26.8 26.8 0 0 0 28 48.15c13.1 0 22.6-9.25 22.6-22.2S41.1 4.2 28 4.2Z" />
              <circle cx="28" cy="25.9" r="8.2" />
            </svg>
          </a>
